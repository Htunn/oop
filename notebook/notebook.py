...
class Note:
    ...
    def __init__(self, memo, tags=''):
        '''initialize a note with memo and optional space-seperated tags. Automatically set the
    ...
    def match(self, filter):
        '''Determine if this note matches the filter text. Return True if it matches, False
        otherwise.
